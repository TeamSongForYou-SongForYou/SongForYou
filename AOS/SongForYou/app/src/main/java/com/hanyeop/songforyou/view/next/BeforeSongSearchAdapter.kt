...
import com.hanyeop.songforyou.databinding.ItemBeforeSongBinding
import com.hanyeop.songforyou.databinding.ItemRecommendListBinding
import com.hanyeop.songforyou.model.response.SongResponse

class BeforeSongSearchAdapter (private val listener: SongSearchListener): ListAdapter<SongResponse, BeforeSongSearchAdapter.ViewHolder>(diffUtil) {

    inner class ViewHolder(private val binding: ItemBeforeSongBinding) :
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): ViewHolder {
        val binding =
            ItemBeforeSongBinding.inflate(LayoutInflater.from(parent.context), parent, false)
